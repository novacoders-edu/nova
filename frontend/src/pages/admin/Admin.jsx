...
const Toast = ({ message, type, onClose }) => (
  <motion.div
    ...
    className={`fixed bottom-4 right-4 flex items-center gap-3 px-6 py-4 rounded-2xl shadow-2xl backdrop-blur-md border ${
      type === "success"
...
const Admin = () => {
  ...
  const isAdmin =
    user?.role === "admin" || user?.email?.includes("admin") || user?.isAdmin;
    ...
    try {
      if (type === "member") {
        ...
        if (result.success) {
          ...
          showToast(
            result.error?.message || "Failed to delete member",
            "error",
          );
        }
      } else {
      ...
      <div className="min-h-screen bg-[#0f172a] flex items-center justify-center relative overflow-hidden">
        ...
        >
          ...
          <p className="text-slate-400 mb-8">
            You don't have the required administrative privileges to view this
            area.
          </p>
          <a
            href="/"
            className="inline-flex items-center justify-center px-6 py-3 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-medium transition-colors"
          >
            Return Home
          </a>
        </motion.div>
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3">
                    <div
                      className={`p-2 rounded-lg ${isActive ? tab.bg : "bg-slate-800"} transition-colors`}
                    >
                      <Icon
          ...
          <div>
            ...
            <p className="text-sm text-slate-400">
              {activeTab === "members"
                ...
                : "Review and handle incoming messages"}
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            >
              ...
              <div className="mt-4 flex items-center text-xs text-green-400">
                <span className="bg-green-500/10 px-2 py-1 rounded-full">
                  +Active community
                </span>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="mt-4 flex items-center text-xs text-blue-400">
                <span className="bg-blue-500/10 px-2 py-1 rounded-full">
                  All messages
                </span>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="mt-4 flex items-center text-xs text-red-400">
                <span className="bg-red-500/10 px-2 py-1 rounded-full">
                  Requires attention
                </span>
              </div>
            </motion.div>
                    ...
                    {members.length === 0 ? (
                      <div className="p-12 text-center">
                        ...
                        <p className="text-slate-400 mt-1">
                          Your community is currently empty.
                        </p>
                      </div>
                    ) : (
                              ...
                              >
                                ...
                                <td className="px-6 py-4">
                                  <div className="flex flex-col gap-1">
                                    ...
                                    <span className="text-xs text-slate-500 bg-slate-800 px-2 py-0.5 rounded w-fit">
                                      Year: {member.year}
                                    </span>
                                  </div>
                                </td>
                                ...
                                <td className="px-6 py-4 text-right">
                                  <button
                                    onClick={() =>
                                      confirmDelete(member._id, "member")
                                    }
                  ...
                  >
                    {contacts.length === 0 ? (
                      ...
                      contacts.map((contact) => (
                        <div
                          key={contact._id}
                          className="bg-slate-800/40 border border-slate-700/50 rounded-2xl p-6 hover:bg-slate-800/60 transition-colors group relative"
                        >
                          ...
                          <button
                            onClick={() =>
                              confirmDelete(contact._id, "contact")
                            }
