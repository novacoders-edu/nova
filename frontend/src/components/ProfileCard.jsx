      ...
      <div ref={shellRef} className="relative z-[1] group">
        <section
          ...
          style={{
            ...
            boxShadow:
              'rgba(0, 0, 0, 0.8) calc((var(--pointer-from-left) * 10px) - 3px) calc((var(--pointer-from-top) * 20px) - 6px) 20px -5px, inset 0 0 0 1px rgba(255, 255, 255, calc(0.08 + 0.12 * var(--pointer-from-center)))',
                ...
                <div
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col items-start gap-1">
                      ...
                      <div className="text-[10px] text-white/50 leading-none mb-1">{status}</div>
                          ...
                          {socialLinks.map((link, idx) => {
                            ...
                            return (
                              <a
                                ...
                                className="text-white/60 hover:text-cyan-400 hover:scale-110 transition-all p-1 bg-white/5 hover:bg-cyan-500/10 rounded-md border border-white/5 hover:border-cyan-500/20"
                                aria-label={isGithub ? "GitHub Profile" : isLinkedin ? "LinkedIn Profile" : "Social Link"}
                              >
                                {isGithub ? (
                                  ...
                                  <span className="text-[10px] uppercase font-bold px-0.5">link</span>
                                )}
                              </a>
                            );
                          })}
